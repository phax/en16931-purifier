 ...
 */
@Immutable
public final class PurifierVersion
{
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger (PurifierVersion.class);

  static
  {
    String sProjectVersion = null;
    String sProjectTimestamp = null;
    final NonBlockingProperties p = PropertiesHelper.loadProperties (ClassPathResource.getInputStream ("purifier-version.properties",
                                                                                                       PurifierVersion.class.getClassLoader ()));
    if (p != null)
    {
