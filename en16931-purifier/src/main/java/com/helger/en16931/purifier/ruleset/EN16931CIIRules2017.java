...
/**
 * The EN 16931:2017 core message in the CII syntax, according to CEN/TS 16931-3-3. The rule set
 * created by this class is valid for all CII versions, because all of them use the same XML
 ...
 */
@Immutable
public final class EN16931CIIRules2017
{
                                                ...
                                                @NonNull @Nonempty final String sBase)
  {
    ...
    aB.addKeepWhenEmpty (null, sBase + "/ram:ChargeIndicator", ONCE);
    aB.add (null, sBase + "/ram:ChargeIndicator/udt:Indicator", ONCE);
  }
  ...
  private static void _addDocumentContextRules (@NonNull final PurificationRuleSetBuilder aB)
  {
    ...
    _addDateTimeRules (aB, "BT-2", DOCUMENT + "/ram:IssueDateTime");
    // BG-1 INVOICE NOTE
  ...
  private static void _addLineRules (@NonNull final PurificationRuleSetBuilder aB)
  {
    ...
    aB.add ("BT-132", LINE_AGREEMENT + "/ram:BuyerOrderReferencedDocument", ONCE);
    aB.add ("BT-132", LINE_AGREEMENT + "/ram:BuyerOrderReferencedDocument/ram:LineID", ONCE);
    aB.add ("BT-148", LINE_AGREEMENT + "/ram:GrossPriceProductTradePrice", ONCE);
    aB.add ("BT-148", LINE_AGREEMENT + "/ram:GrossPriceProductTradePrice/ram:ChargeAmount", ONCE);
    aB.add ("BT-147", LINE_AGREEMENT + "/ram:GrossPriceProductTradePrice/ram:AppliedTradeAllowanceCharge", ONCE);
    _addChargeIndicatorRules (aB, LINE_AGREEMENT + "/ram:GrossPriceProductTradePrice/ram:AppliedTradeAllowanceCharge");
    aB.add ("BT-147",
            LINE_AGREEMENT + "/ram:GrossPriceProductTradePrice/ram:AppliedTradeAllowanceCharge/ram:ActualAmount",
            ONCE);
    aB.add ("BT-146", LINE_AGREEMENT + "/ram:NetPriceProductTradePrice", ONCE);
    aB.add ("BT-146", LINE_AGREEMENT + "/ram:NetPriceProductTradePrice/ram:ChargeAmount", ONCE);
    aB.add ("BT-149", LINE_AGREEMENT + "/ram:NetPriceProductTradePrice/ram:BasisQuantity", ONCE, "unitCode");

    // BT-129 Invoiced quantity
    aB.add ("BT-129", LINE_DELIVERY, ONCE);
    ...
    aB.add (null, LINE_SETTLEMENT + "/ram:ApplicableTradeTax/ram:TypeCode", ONCE);
    ...
    _addChargeIndicatorRules (aB, sLineAllowanceCharge);
    ...
    aB.add ("BT-140/BT-145", sLineAllowanceCharge + "/ram:ReasonCode", ONCE);
    ...
    aB.add ("BT-128", LINE_SETTLEMENT + "/ram:AdditionalReferencedDocument", ONCE);
    aB.add ("BT-128", LINE_SETTLEMENT + "/ram:AdditionalReferencedDocument/ram:IssuerAssignedID", ONCE);
    aB.add ("BT-128-1", LINE_SETTLEMENT + "/ram:AdditionalReferencedDocument/ram:ReferenceTypeCode", ONCE);
    aB.add (null, LINE_SETTLEMENT + "/ram:AdditionalReferencedDocument/ram:TypeCode", ONCE);
  ...
  private static void _addAgreementRules (@NonNull final PurificationRuleSetBuilder aB)
  {
    ...
    aB.add ("BT-10", AGREEMENT + "/ram:BuyerReference", ONCE);

    // BG-4 SELLER
    aB.add ("BG-4", SELLER, ONCE);
    aB.add ("BT-29", SELLER + "/ram:ID", UNBOUNDED);
    ...
    aB.add ("BT-46", BUYER + "/ram:ID", ONCE);
    aB.add ("BT-46", BUYER + "/ram:GlobalID", ONCE, "schemeID");
    ...
    aB.add (null, ADR_BT17 + "/ram:TypeCode", ONCE);
    ...
    aB.add (null, ADR_BT18 + "/ram:TypeCode", ONCE);
    ...
    aB.add (null, ADR_BG24 + "/ram:TypeCode", ONCE);

    // BT-11 Project reference - ram:Name is mandatory in the XML Schema
    ...
    aB.add (null, AGREEMENT + "/ram:SpecifiedProcuringProject/ram:Name", ONCE);
  }

  private static void _addDeliveryRules (@NonNull final PurificationRuleSetBuilder aB)
  {
    // ram:ApplicableHeaderTradeDelivery is mandatory in the XML Schema and is regularly empty
    aB.addKeepWhenEmpty ("BG-13", DELIVERY, ONCE);
    aB.add ("BG-13", SHIP_TO, ONCE);
    aB.add ("BT-71", SHIP_TO + "/ram:ID", ONCE);
  ...
  {
    // ram:ApplicableHeaderTradeSettlement is mandatory in the XML Schema
    ...
    aB.add ("BT-60", PAYEE + "/ram:ID", ONCE);
    ...
    aB.add ("BT-91", PAYMENT_MEANS + "/ram:PayerPartyDebtorFinancialAccount", ONCE);
    ...
    aB.add (null, TRADE_TAX + "/ram:TypeCode", ONCE);
    ...
    _addChargeIndicatorRules (aB, ALLOWANCE_CHARGE);
    ...
    aB.add ("BT-98/BT-105", ALLOWANCE_CHARGE + "/ram:ReasonCode", ONCE);
    aB.add ("BT-97/BT-104", ALLOWANCE_CHARGE + "/ram:Reason", ONCE);
    aB.add ("BT-95/BT-102", ALLOWANCE_CHARGE + "/ram:CategoryTradeTax", ONCE);
    aB.add (null, ALLOWANCE_CHARGE + "/ram:CategoryTradeTax/ram:TypeCode", ONCE);
    ...
    // BT-20 Payment terms, BT-9 Payment due date and BT-89 Mandate reference identifier
    aB.add ("BT-20", PAYMENT_TERMS, ONCE);
  ...
  /**
   * @return The EN 16931:2017 rule set for a CII CrossIndustryInvoice. Never <code>null</code>.
   */
  @NonNull
